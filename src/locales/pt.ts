...
export const pt: Translation = {
    ...
    about: {
        title: "Moldando o Futuro dos Negócios",
        subtitle: "A Equipa por Trás da Framax",
        introduction: "Somos mais do que apenas uma agência de desenvolvimento. Somos os seus parceiros estratégicos na transformação digital, unindo tecnologia de ponta com resultados focados no negócio.",
        missionTitle: "A Nossa Missão",
        missionDesc: "Capacitar empresas através da criação de soluções digitais de alto desempenho que resolvem problemas reais e impulsionam o crescimento sustentável.",
        visionTitle: "A Nossa Visão",
        visionDesc: "Tornarmo-nos o padrão global para experiências web de alta conversão, onde a tecnologia e a intuição humana se fundem de forma harmoniosa.",
        stats: {
            projects: "50+",
            projectsLabel: "Projetos de Sucesso",
            clients: "30+",
            clientsLabel: "Clientes Felizes",
            coffee: "1.2k",
            coffeeLabel: "Chávenas de Café",
            hours: "5k+",
        ...
        values: {
            ...
            innovationDesc: "Não seguimos tendências; criamo-las com soluções de engenharia personalizadas.",
            transparencyTitle: "Transparência",
            transparencyDesc: "Comunicação clara e feedback honesto em cada etapa da jornada.",
            resultsTitle: "Foco em Resultados",
            resultsDesc: "Medimos o nosso sucesso através do crescimento e ROI que trazemos ao seu negócio.",
            resilienceTitle: "Resiliência",
            resilienceDesc: "Superamos desafios complexos com engenharia criativa e robusta.",
        },
        maksym: {
            name: "Maksym Grebeniuk",
            role: "Co-Fundador & Engenheiro Principal",
            description: "Arquiteto full-stack com uma paixão profunda por sistemas escaláveis e automação. O Maksym lidera a direção técnica, garantindo que cada linha de código seja otimizada para o máximo desempenho.",
        },
        francisco: {
            name: "Francisco Farias",
            role: "Co-Fundador & Estrategista de Crescimento",
            description: "Estrategista digital e programador focado na interseção entre design e conversão. O Francisco garante que cada projeto não só tenha um aspeto deslumbrante, como funcione como um motor de vendas potente.",
        },
