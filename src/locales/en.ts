...
export const en: Translation = {
    ...
    about: {
        title: "Crafting the Future of Business",
        subtitle: "The Team Behind Framax",
        introduction: "We are more than just a development agency. We are your strategic partners in digital transformation, blending cutting-edge technology with business-driven results.",
        missionTitle: "Our Mission",
        missionDesc: "To empower businesses by building high-performance digital solutions that solve real-world problems and drive sustainable growth.",
        visionTitle: "Our Vision",
        visionDesc: "To become the global standard for high-conversion web experiences, where technology meets human intuition seamlessly.",
        stats: {
            projects: "50+",
            projectsLabel: "Success Projects",
            clients: "30+",
            clientsLabel: "Happy Clients",
            coffee: "1.2k",
            coffeeLabel: "Cups of Coffee",
            hours: "5k+",
            hoursLabel: "Hours of Code",
        },
        valuesTitle: "Our Core Values",
        values: {
            innovationTitle: "Innovation",
            innovationDesc: "We don't follow trends; we set them with custom-engineered solutions.",
            transparencyTitle: "Transparency",
            transparencyDesc: "Clear communication and honest feedback at every stage of the journey.",
            resultsTitle: "Results-Driven",
            resultsDesc: "We measure our success by the growth and ROI we bring to your business.",
            resilienceTitle: "Resilience",
            resilienceDesc: "We overcome complex challenges with creative and robust engineering.",
        },
        maksym: {
            name: "Maksym Grebeniuk",
            role: "Co-Founder & Lead Engineer",
            description: "Full-stack architect with a deep passion for scalable systems and automation. Maksym leads the technical direction, ensuring every line of code is optimized for the highest performance.",
        },
        francisco: {
            name: "Francisco Farias",
            role: "Co-Founder & Growth Strategist",
            description: "Digital strategist and developer focused on the intersection of design and conversion. Francisco ensures that every project not only looks stunning but functions as a powerful sales engine.",
        },
